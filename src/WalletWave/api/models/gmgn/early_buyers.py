...
class EarlyBuyersData(BaseModel):
    maker: str
    base_amount: str
    quote_amount: str
    quote_symbol: str
...
class EarlyBuyersResponseData(BaseModel):
    history: List[EarlyBuyersData]
...
class EarlyBuyersResponse(BaseModel):
    ...
    reason: str
    message: str
    data: EarlyBuyersResponseData

    @property
    def buyer_data(self) -> EarlyBuyersResponseData:
        """
